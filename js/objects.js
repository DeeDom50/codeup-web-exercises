(function() {
    ...
    shoppers.forEach(function(shopper) {
            ...
            if (amount > 200) {
                console.log("Name: " + shopper.name + "." + " Amount: " + "$" + shopper.amount + "," + " Discount: " + "$" +
                    (shopper.amount * .12) + "," + " Total: " + "$" + (shopper.amount - (shopper.amount * .12)));
            } else {
                if (amount < 200) {
                    console.log(shopper.name + " doesn't qualify for discount!")
                }
            }
        }
    ...
    books.push(createBook("The Missing", "Roger", "Hayden"));

    const showBookInfo = function(book, i){
        console.log("Book: # " + (i + 1));
        console.log("Title: " + book.title);
        console.log("Author: " + book.author.firstName + " " +  book.author.lastName);
        console.log("...");
